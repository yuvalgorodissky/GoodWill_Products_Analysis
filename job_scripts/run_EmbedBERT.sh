...
#SBATCH --job-name EmbedBERT_yuvalgor			### name of the job
#SBATCH --output /sise/eliorsu-group/yuvalgor/courses/Data-mining-in-Big-Data/job_scripts/out/EmbedBERT_job-%J.out			### output log for running job - %J for job number
...
python /sise/eliorsu-group/yuvalgor/courses/Data-mining-in-Big-Data/src/EmbedBERT.py
